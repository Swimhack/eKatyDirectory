/**
 * Script to repopulate blog articles in the database
 * Run with: npx ts-node scripts/repopulate-blog-articles.ts
 */
...
const articles = [
  ...
  },
  {
    ...
    publishedDate: new Date('2025-09-19'),
  ...
  },
  {
    ...
    publishedDate: new Date('2025-09-26'),
  ...
  },
  {
    ...
    publishedDate: new Date('2025-10-03'),
...
async function repopulateArticles() {
  console.log('🚀 Starting blog article repopulation...\n')
