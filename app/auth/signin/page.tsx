...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate authentication - In production, integrate with Supabase or NextAuth
    setTimeout(() => {
      if (formData.email === 'demo@ekaty.com' && formData.password === 'demo123') {
